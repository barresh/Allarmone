      ...
      if (mittente == "11") {
        if (destinatario == "ff") {
          ...
          if (payload == "02") {
            ...
            var colonna49 = bufferino.slice(96, 98);
            var colonna50 = bufferino.slice(98, 100);
            var colonna51 = bufferino.slice(102, 104);
            var colonna52 = bufferino.slice(104, 106);
            var colonna53 = bufferino.slice(106, 108);
            var colonna54 = bufferino.slice(108, 110);
            var colonna55 = bufferino.slice(110, 112);
