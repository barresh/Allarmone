        ...
        if (destinatario == "ff") {
          ...
          if (payload == "01") {
            ...
            if (completo == "00") {
              ...
              var stato4bin = hex2bin(result[6]);
              var stato5bin = hex2bin(result[7]);
              var colonna13bin = hex2bin(result[8]);
              var colonna14bin = hex2bin(result[9]);
              //15 e 16 0001 lasciare stare presenza negativo ecc
              var colonna15bin = hex2bin(result[10]);
              var colonna16bin = hex2bin(result[11]);
              var colonna17bin = hex2bin(result[12]);
              var colonna18bin = hex2bin(result[13]);
              var colonna19bin = hex2bin(result[14]);
              var colonna20bin = hex2bin(result[15]);
              var colonna21bin = hex2bin(result[16]);
              var colonna22bin = hex2bin(result[17]);
              var colonna23bin = hex2bin(result[18]);
              var colonna24bin = hex2bin(result[19]);
              var colonna25bin = hex2bin(result[20]);
              var colonna26bin = hex2bin(result[21]);
              var colonna27bin = hex2bin(result[22]);
              var colonna28bin = hex2bin(result[23]);
              var colonna29bin = hex2bin(result[24]);
              var colonna30bin = hex2bin(result[25]);
              var colonna31bin = hex2bin(result[26]);
              var colonna32bin = hex2bin(result[27]);
              var colonna33bin = hex2bin(result[28]);
              var colonna34bin = hex2bin(result[29]);
              var colonna35bin = hex2bin(result[30]);
              var colonna36bin = hex2bin(result[31]);
              var colonna37bin = hex2bin(result[32]);
              var colonna38bin = hex2bin(result[33]);
              var colonna39bin = hex2bin(result[34]);
              var colonna40bin = hex2bin(result[35]);
              var colonna41bin = hex2bin(result[36]);
              var colonna42bin = hex2bin(result[37]);
              var colonna43bin = hex2bin(result[38]);
              var colonna44bin = hex2bin(result[39]);
              var colonna45bin = hex2bin(result[40]);
              var colonna46bin = hex2bin(result[41]);
              var colonna47bin = hex2bin(result[42]);
              var colonna48bin = hex2bin(result[43]);
              var colonna49bin = hex2bin(result[44]);
              var colonna50bin = hex2bin(result[45]);
              var colonna51bin = hex2bin(result[46]);
              var colonna52bin = hex2bin(result[47]);
              var colonna53bin = hex2bin(result[48]);
              var colonna54bin = hex2bin(result[49]);
              var colonna55bin = hex2bin(result[50]);
              var colonna56bin = hex2bin(result[51]);
              var colonna57bin = hex2bin(result[52]);
              var colonna58bin = hex2bin(result[53]);
              var colonna59bin = hex2bin(result[54]);
              var colonna60bin = hex2bin(result[55]);
              var colonna61bin = hex2bin(result[56]);
              var colonna62bin = hex2bin(result[57]);
              var colonna63bin = hex2bin(result[58]);
              var colonna64bin = hex2bin(result[59]);
              var colonna65bin = hex2bin(result[60]);
              var colonna66bin = hex2bin(result[61]);
              var colonna67bin = hex2bin(result[62]);
              var colonna68bin = hex2bin(result[63]);
              var colonna69bin = hex2bin(result[64]);
              var colonna70bin = hex2bin(result[65]);
              var colonna71bin = hex2bin(result[66]);
              var colonna72bin = hex2bin(result[67]);
              var colonna73bin = hex2bin(result[68]);
              var colonna74bin = hex2bin(result[69]);
              var colonna75bin = hex2bin(result[70]);
              var colonna76bin = hex2bin(result[71]);
              var colonna77bin = hex2bin(result[72]);
              var colonna78bin = hex2bin(result[73]);
              var colonna79bin = hex2bin(result[74]);
              var colonna80bin = hex2bin(result[75]);
              var colonna81bin = hex2bin(result[76]);
              var colonna82bin = hex2bin(result[77]);
              var colonna83bin = hex2bin(result[78]);
              var colonna84bin = hex2bin(result[79]);
              var colonna85bin = hex2bin(result[80]);
              var colonna86bin = hex2bin(result[81]);
              var colonna87bin = hex2bin(result[82]);
              var colonna88bin = hex2bin(result[83]);
              var colonna89bin = hex2bin(result[84]);
              var colonna90bin = hex2bin(result[85]);
              var colonna91bin = hex2bin(result[86]);
              var colonna92bin = hex2bin(result[87]);
              var colonna93bin = hex2bin(result[88]);
              var colonna94bin = hex2bin(result[89]);
              var colonna95bin = hex2bin(result[90]);
              var colonna96bin = hex2bin(result[91]);
              var colonna97bin = hex2bin(result[92]);
              var risultato;
              switch (stato1bin) {
                case "10000000":
